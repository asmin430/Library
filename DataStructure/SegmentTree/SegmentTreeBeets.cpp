...
private:
   ...
   public:
    ...
    void apply_chmin(int l, int r, T x) { inner_chmin(l, r, x); }
    void apply_chmax(int l, int r, T x) { inner_chmax(l, r, x); }
    void apply_add(int l, int r, T x) { inner_add(l, r, x); }
    void apply_update(int l, int r, T x) { inner_update(l, r, x); }
    T query_min(int l, int r) { return inner_min(l, r); }
    T query_max(int l, int r) { return inner_max(l, r); }
    T query_sum(int l, int r) { return inner_sum(l, r); }
};
